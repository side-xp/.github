...
In most of our projects, we follow the [*Conventional Commits* specification](https://www.conventionalcommits.org) for both clarity and automation purposes.

This document is a basic summary of the specification and how we use it, but you can find more details on the [*Conventional Commits* specification](https://www.conventionalcommits.org) website.
...
A scope is an optional part. It's a noun or an abbreviation for the subject of a change. Projects may have a shortlist of allowed scopes, but there are no common rules.
